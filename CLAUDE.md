...
- **DPDP citations** — rules name principles, not sections. The section mapping is now **drafted** in `docs/compliance/dpdp-provision-map.md` (s.4, s.5, s.6, s.7, s.8(1)/(4)/(5)/(7)/(8), s.10) and marked *to be verified against the Gazette text* before it enters the report — clause letters in s.7 and sub-sections of s.8 are the likely transcription errors. The Act has no free-standing minimisation article; the report must say DM-01 is derived from s.6(1) + s.4(1).
