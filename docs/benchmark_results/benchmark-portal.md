...
_compliance-aware (ours) scores 1.000; unconstrained (baseline) scores 0.131 on the same 7 rules -- a 0.869 gap. It also pulls 1.00x the fields the purpose requires, against 5.56x for the baseline, at full coverage. That surplus is exactly what the data-minimisation rule penalises, so on this workload compliance and extraction cost move together rather than trading off against each other._

Synthetic data: portal, 10 records/module, seed 42. 2 extraction tasks, identical DPDP rule set for every technique. Generated 2026-09-12 in 8685 ms.
...
|---|---|---|---|---|---|---|---|---|
| compliance-aware (ours) | 1.000 | 1.00 | 1.00 | 90 | 4 | 28 | 40 | 1765.7 |
| minimising, undocumented | 0.500 | 1.00 | 1.00 | 90 | 4 | 28 | 40 | 1805.8 |
| unconstrained (baseline) | 0.131 | 5.56 | 1.00 | 500 | 8 | 96 | 80 | 5112.2 |
...
- **compliance-aware** — 40 records across 2 layer(s); fields by category: administrative (20), clinical (10), direct_identifier (20), quasi_identifier (10); out-of-scope: none
- **minimising** — 40 records across 2 layer(s); fields by category: administrative (20), clinical (10), direct_identifier (20), quasi_identifier (10); out-of-scope: none
- **unconstrained** — 80 records across 4 layer(s); fields by category: administrative (60), clinical (40), contact (20), direct_identifier (20), financial (20), quasi_identifier (20); out-of-scope: contact, financial
