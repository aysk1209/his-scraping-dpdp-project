...
Synthetic data: portal, 30 records/module, seed 42. 2 extraction tasks, identical DPDP rule set for every technique. Generated 2026-09-12 in 23525 ms.
...
|---|---|---|---|---|---|---|---|---|
| compliance-aware (ours) | 1.000 | 1.00 | 1.00 | 270 | 4 | 68 | 120 | 4602.2 |
| minimising, undocumented | 0.500 | 1.00 | 1.00 | 270 | 4 | 68 | 120 | 4447.9 |
| unconstrained (baseline) | 0.131 | 5.56 | 1.00 | 1500 | 8 | 256 | 240 | 14473.5 |
...
- **unconstrained** — 240 records across 4 layer(s); fields by category: administrative (180), clinical (120), contact (60), direct_identifier (60), financial (60), quasi_identifier (60); out-of-scope: contact, financial
