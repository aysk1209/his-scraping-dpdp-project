...
Source: 50 records/layer x 5 layers, seed 42. 4 extraction tasks, identical DPDP rule set for every technique. Generated 2026-09-16 in 26 ms (wall-clock, hardware-dependent).
...
|---|---|---|---|---|---|---|---|---|---|---|
| compliance-aware (ours) | 1.000 | 1.00 | 1.00 | 19 / 19 | 950 | 7 | n/a | 350 | 1.0 | 5 / 5 |
| unconstrained (baseline) | 0.134 | 6.53 | 1.00 | 124 / 19 | 6200 | 20 | n/a | 1000 | 3.6 | 5 / 5 |
