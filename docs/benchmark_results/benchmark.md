...
Source: 50 records/layer x 5 layers, seed 42. 4 extraction tasks, identical DPDP rule set for every technique. Generated 2026-09-15 in 21 ms (wall-clock, hardware-dependent).
...
|---|---|---|---|---|---|---|---|---|---|
| compliance-aware (ours) | 1.000 | 1.00 | 1.00 | 19 / 19 | 950 | 7 | n/a | 350 | 1.0 |
| morality (privacy by instinct) | 0.482 | 0.90 | 0.90 | 17 / 19 | 850 | 7 | n/a | 350 | 1.0 |
| unconstrained (baseline) | 0.134 | 6.53 | 1.00 | 124 / 19 | 6200 | 20 | n/a | 1000 | 3.9 |
...
- **morality** — 350 records across 2 layer(s); records carrying each category: administrative (150), clinical (100), direct_identifier (200), quasi_identifier (100); out-of-scope: none
