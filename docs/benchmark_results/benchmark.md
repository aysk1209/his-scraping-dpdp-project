...
Synthetic data: 50 records/layer x 5 layers, seed 42. 4 extraction tasks, identical DPDP rule set for every technique. Generated 2026-09-15 in 27 ms.
...
|---|---|---|---|---|---|---|---|---|
| compliance-aware (ours) | 1.000 | 1.00 | 1.00 | 950 | 7 | n/a | 350 | 1.0 |
| morality (privacy by instinct) | 0.482 | 0.90 | 0.90 | 850 | 7 | n/a | 350 | 0.9 |
| unconstrained (baseline) | 0.134 | 6.53 | 1.00 | 6200 | 20 | n/a | 1000 | 6.2 |
